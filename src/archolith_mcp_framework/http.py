"""Small ASGI request-correlation helpers for HTTP-exposed MCP surfaces."""
...
_request_id_var: ContextVar[str | None] = ContextVar("archolith_mcp_request_id", default=None)
